...
__decorate([
    (0, class_validator_1.IsNumber)({}, { message: 'Concert ID must be a number' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'Concert ID is required' }),
    (0, class_validator_1.IsPositive)({ message: 'Concert ID must be a positive number' }),
    __metadata("design:type", Number)
], CreateReservationDto.prototype, "concertId", void 0);
